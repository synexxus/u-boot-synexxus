...
@ -I /home/jtreep/ARM/uboot/u-boot/arch/arm/include -imultilib sf
@ -imultiarch arm-linux-gnueabi -D __KERNEL__
@ -D CONFIG_SYS_TEXT_BASE=0x17800000 -D CONFIG_ARM -D __ARM__
...
@ -mno-unaligned-access -mfloat-abi=soft -mfpu=vfpv3-d16 -mtls-dialect=gnu
...
.LFE144:
	...
	.text
.Letext0:
	.file 2 "/home/jtreep/ARM/uboot/u-boot/arch/arm/include/asm/types.h"
...
.LASF68:
	.ascii	"GNU C 4.8.2 -marm -mno-thumb-interwork -mabi=aapcs-"
	.ascii	"linux -mword-relocations -march=armv7-a -mno-unalig"
	.ascii	"ned-access -mfloat-abi=soft -mfpu=vfpv3-d16 -mtls-d"
...
.LASF58:
	.ascii	"LINKLOCAL\000"
.LASF70:
	.ascii	"/home/jtreep/ARM/uboot/u-boot\000"
.LASF14:
	.ascii	"size\000"
.LASF21:
