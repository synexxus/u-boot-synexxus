cmd_board/synexxus/aristeus/aristeus.cfg.cfgtmp := arm-linux-gnueabihf-gcc -E -Wp,-MD,board/synexxus/aristeus/.aristeus.cfg.cfgtmp.d  -nostdinc -isystem /usr/lib/gcc-cross/arm-linux-gnueabihf/4.8/include -Iinclude  -I/home/jtreep/ARM/uboot/u-boot/arch/arm/include -D__KERNEL__ -DCONFIG_SYS_TEXT_BASE=0x17800000    -DCONFIG_ARM -D__ARM__ -marm -mno-thumb-interwork  -mabi=aapcs-linux  -mword-relocations  -march=armv7-a  -mno-unaligned-access  -ffunction-sections -fdata-sections -fno-common -ffixed-r9  -msoft-float  -pipe   -x c -o board/synexxus/aristeus/aristeus.cfg.cfgtmp board/synexxus/aristeus/aristeus.cfg

source_board/synexxus/aristeus/aristeus.cfg.cfgtmp := board/synexxus/aristeus/aristeus.cfg

deps_board/synexxus/aristeus/aristeus.cfg.cfgtmp := \
  include/config.h \
  ...
  board/synexxus/aristeus/ddr-setup-aristeus.cfg \
  board/synexxus/aristeus/1066mhz_4x128mx16_aristeus.cfg \
  board/synexxus/aristeus/clocks-aristeus.cfg \

board/synexxus/aristeus/aristeus.cfg.cfgtmp: $(deps_board/synexxus/aristeus/aristeus.cfg.cfgtmp)
